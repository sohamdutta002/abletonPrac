  ...
  return (
    <div>
        <header className='main-nav w-[100vw] 2xl:w-full '>
                    <nav className='primary flex gap-8 items-center lg:justify-between text-[1.25rem] lg:text-[.9rem] xl:text-[1.25rem] font-semibold pt-6 mb-4 pl-[1.5rem] pr-4'>
                    ...
                    <nav className='secondary pl-[1.5rem] pt-4'>
                        <ul className='flex gap-5 font-semibold text-[.875rem] lg:text-[1rem]'>
                            <li className='text-[#ff764d]'><a href='#'>About</a></li>
                            <li><a href='#'>Jobs</a></li>
